...
public class Join extends JFrame {
	...
	private void init() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(91)
					.addComponent(btnJoin, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE)
					.addGap(42)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(btnJoin, GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)))
		);
	...
	public void start() { // 액션이벤트 지정 메소드
		...
		btnJoin.addActionListener(new btnJoinAction()); // 취소 버튼
	}
