...
public class Help extends JFrame {
	...
	private void init() {
		...
		appendI2("icon/help/CH_1.JPG",txtArea1);
		appendI2("icon/help/CH_2.JPG",txtArea1);
		...
		appendI2("icon/help/CH_3.JPG",txtArea2);
		...
		appendI2("icon/help/CH_4.JPG",txtArea3);
		...
		appendI2("icon/help/CH_5.JPG",txtArea4);
